  ...
  <div class="completed">
    <div class="flex items-center justify-between">
      <p class="font-norm-16">
        Completed Courses for <span class="font-bold">"All Course"</span>
      </p>
      <div class="flex items-center">
        <div class="flex bg-white p-[10px]">
          <p class="font-norm-13 text-[#58606a]">Sort By:</p>
          <select class="font-600-13">
        ...
        <div
          class="w-[42px] h-[42px] bg-white mx-[10px] flex items-center justify-center"
        >
          <svg
            width="13"
            height="12"
        ...
        <div
          class="w-[42px] h-[42px] bg-[blue] rounded-l flex items-center justify-center"
        >
          <svg
            width="15"
            height="15"
        ...
        <div
          class="w-[42px] h-[42px] bg-white rounded-r flex items-center justify-center"
        >
          <svg
            width="15"
            height="15"
    ...
    <div class="grid grid-cols-12 gap-[23px]">
      <div
        ...
        :key="course.id"
        class="col-span-full md:col-span-4 sm:col-span-6"
      >
        <FinishedCourseCard :course="course" />
      </div>
    </div>
  </div>
</template>
...
<script>
import FinishedCourseCard from '../components/FinishedCourseCard.vue';
export default {
  components: { FinishedCourseCard },
  name: "CompletedPage",
  layout: "custom",
  computed: {
    courses() {
